...
describe('Read in simple CSV VOTable.', function() {
    ...
    var testSubject = new opencadcVOTableRowBuilder.RowBuilderFactory().createBuilder(
        input
    );
    ...
    it('Load data.', function() {
        ...
        testSubject.subscribe(
            opencadcVOTableRowBuilder.events.onRowAdd,
            onRowAddEventHandler
        );
        testSubject.subscribe(
            opencadcVOTableRowBuilder.events.onPageAddEnd,
            onPageAddEventHandler
        );
