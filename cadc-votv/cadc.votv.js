...
(function ($, window, undefined) {
  ...
  function Viewer(targetNodeSelector, options) {
    ...
    function addRow(row, rowIndex) {
      ...
      trigger(cadc.vot.events.onRowAdded, {
        rowData: dataRow
      })
    }
    ...
    function init() {
      ...
      var enableSelection = !getOptions().enableSelection || getOptions().enableSelection == true
      ...
      if (getRowManager().onRowRendered) {
        _self.grid.onRenderComplete.subscribe(function (e, args) {
          ...
          for (
            var i = renderedRange.top, ii = renderedRange.bottom; i <= ii; i++
          ) {
