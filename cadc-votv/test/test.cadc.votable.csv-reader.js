...
describe("Read in simple CSV VOTable.", function ()
{
  ...
  it('Load data.', function ()
  {
    ...
    testSubject.subscribe(opencadcVOTableReader.events.onRowAdd, onRowAddEventHandler);
    testSubject.subscribe(opencadcVOTableReader.events.onPageAddEnd, onPageAddEventHandler);
