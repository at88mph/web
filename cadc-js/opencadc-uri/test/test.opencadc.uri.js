...
{
  var testSubject = new opencadcJS.URI("http://www.mysite.com/path/1/2/item.txt");
...
{
  var testSubject = new opencadcJS.URI("http://www.mysite.com/path/item.txt?a=b&c=d");
...
{
  var testSubject = new opencadcJS.URI("http://www.mysite.com/path/");
...
describe("Set query parameters.", function ()
{
  ...
  it("setQueryValue", function ()
  {
    ...
    {
      assert.equal(e.message, "There are multiple parameters with the name 'param2'.", "Wrong error message.");
    }
  });
});
